        ...
        <div className="bg-[#E9F3F6]  w-11/12 mx-auto py-16 mt-20 rounded-xl">
            ...
            <form action="">
                <ul className="flex flex-col md:flex-row justify-center gap-16 items-center md:items-start">
                    ...
                    <li>
                        <label htmlFor="" className="font-bold text-base">Person</label> <br />
                        <div className="form-control  ">
                            <div className="flex flex-col md:flex-row gap-5 items-center justify-center bg-white px-5  rounded-xl">
                                ...
                                <span className="font-semibold text-base">Adults</span>
